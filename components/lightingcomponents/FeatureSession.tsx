  ...
  return (
    <section className="w-full bg-white py-12 md:py-20 px-4 md:px-8">
      <div className="max-w-5xl mx-auto text-center mt-10">
        ...
        <div className="w-full relative aspect-[4/5] md:aspect-[1.25/1] rounded-xl overflow-hidden mb-6 mt-6">
          <Image
            src={userimage}
        ...
        <p className="text-[16px] md:text-[20px] text-[#757575] leading-[22px] md:leading-[29px] max-w-3xl font-[600] mx-auto w-[323px] md:w-[779.50px] mt-16 mb-20">
