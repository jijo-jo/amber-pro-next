...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
  className={`fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[345px] max-w-[90%] max-h-[80vh] bg-[#191919] z-50 rounded-lg p-6
...
>
  ...
  <div className="flex flex-col items-center justify-center h-full">
    <div className="flex flex-col text-left gap-y-4 w-full">
    ...
    <div className="text-[#FFFFFF] opacity-60 text-[16px] leading-[28px] tracking-[-2px] mt-6">
